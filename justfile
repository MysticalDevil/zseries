...
projects := "zcli ztui ztmpfile ztotp"
...
check:
  @echo '== Markdown =='
  rumdl check README.md zcli/README.md ztui/README.md ztotp/README.md ztotp/docs/*.md ztmpfile/README.md
  @echo '== zcli =='
...
fmt:
  @echo '== Markdown =='
  rumdl fmt README.md zcli/README.md ztui/README.md ztotp/README.md ztotp/docs/*.md ztmpfile/README.md
  @echo '== Zig fmt =='
